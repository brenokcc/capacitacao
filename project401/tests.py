...
from project401.goal01 import TimeZone, Account
...
class TestTimeZone(unittest.TestCase):
    def test_offset(self):
        ...
        assert tz1.name == 'ABC'
        dt = datetime(2020, 5, 13, 15, 15, 0)
        dt2 = dt + tz1.offset
        assert dt.day == dt2.day
        assert dt.hour, dt2.hour + 2
        assert dt.minute, dt2.minute + 15
