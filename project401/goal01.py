...
class TimeZone:
    ...
    def __repr__(self):
        return "TimeZone(name='{}', offset_hours={}, offset_minutes={})".format(
            self.name, self._offset_hours, self._offset_minutes
        )
...
class Account:
    ...
    def validate_real_number(value, min_value=None):
        ...
        if min_value is not None and value < min_value:
            raise ValueError('Value must be at least {}'.format(min_value))
    ...
    def generate_confirmation_code(self, transaction_code):
        ...
        return '{}-{}-{}-{}'.format(
            transaction_code, self.account_number, dt_str, next(Account.transaction_counter)
        )
